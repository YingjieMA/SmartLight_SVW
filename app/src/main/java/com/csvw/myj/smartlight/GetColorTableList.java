...
//        ColorTamplate colorTamplate1 = new ColorTamplate(2,"kaltweiss",Integer.parseInt("FFEBF7", 16),Integer.parseInt("FFEBF7", 16));
        ...
        this.colorTamplates[1] = new ColorTamplate(2,"kaltweiss","#FEEBF7","#FFEBF7","VW10");
        ...
        this.colorTamplates[4] = new ColorTamplate(5,"greenTea","#00FFAB","#00FFAB");
        ...
        this.colorTamplates[8] = new ColorTamplate(9,"cyan","#0089FF","#0089FF","VW10");
        this.colorTamplates[9] = new ColorTamplate(10,"grun","#00FF22","#00FF22");
        this.colorTamplates[10] = new ColorTamplate(11,"bernstein","#FFA200","FFA200","VW10");
        this.colorTamplates[11] = new ColorTamplate(12,"koralle","#FF5563","#FF5563");
        this.colorTamplates[12] = new ColorTamplate(13,"lila","#4514FF","#4514FF","VW10");
        ...
        this.colorTamplates[20] = new ColorTamplate(21,"blutorange","#FF5F1E","#FF5F1E","VW10");
        this.colorTamplates[21] = new ColorTamplate(22,"pink","#FF008F","#FF008F","VW10");
        this.colorTamplates[22] = new ColorTamplate(23,"dunkeblau","#002CFF","#002CFF","VW10");
        this.colorTamplates[23] = new ColorTamplate(24,"mint","#00FFE5","#00FFE5","VW10");
        this.colorTamplates[24] = new ColorTamplate(25,"limette","#B8FF2D","#B8FF2D");
        this.colorTamplates[25] = new ColorTamplate(26,"rot","#FF001A","#FF001A","VW30");
        ...
        this.colorTamplates[29] = new ColorTamplate(30,"zitronengelb","#E9FF26","#E9FF26","VW10");
